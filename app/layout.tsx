...
export const metadata: Metadata = {
  ...
  keywords: 'caya united, come as you are, game development, programming, learn how to program, make video games, beginner, unity, c#, accessible, accessibility, caia, kaia, kaya, untied',
