...
import { ActionIcon, Button, createTheme, CSSVariablesResolver, InputLabel, ModalHeader, Text, Title } from '@mantine/core'
  ...
  return {
    ...
    theme: createTheme({
      ...
      components: {
        ...
        Button: Button.extend({ defaultProps: { className: classes.button, style: { ...textStyle, fontWeight: 400 } } }),
        ...
        Text: Text.extend({ defaultProps: { style: textStyle } }),
