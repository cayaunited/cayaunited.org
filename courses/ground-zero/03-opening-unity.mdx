export const metadata = {
  ...
  thumbnailAltText: 'Opening Unity and Creating Gems: The video\'s thumbnail, containing a lightbulb that represents coming up with ideas and a plan for a project',
