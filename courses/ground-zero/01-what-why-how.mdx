export const metadata = {
  ...
  orderInCourse: 1,
  thumbnailURL: '/images/ground-zero/01/thumbnail.png',
  thumbnailAltText: 'The What, Why, and How of Programming: The video\'s thumbnail, containing a plant sapling that represents a starting point in the journey to learn programming',
  ...
  videoURL: 'https://www.youtube.com/embed/TerHoIWdUPE',
  nextURL: '02-planning-before-pursuing',
}
...
![A wizard programming at a computer, a game controller, a globe representing the internet, a stick person running, a speaker volume icon, and a couple chess pieces](/images/ground-zero/01/01-wizard-and-icons.png)
...
![A piece of paper with a numbered list of scribble marks representing reminders and a sketch model of a 3D character's rigging in a T-pose](/images/ground-zero/01/02-reminders-and-model.png)
...
![Several icons and text spread about to represent different tools used in programming: C sharp, JavaScript, for loops, curly brackets, functions, if blocks, a gear, and a sketch version of the Unity game engine's logo](/images/ground-zero/01/03-programming-icons.png)
...
![A robot wizard programming and bugs coming out of the computer](/images/ground-zero/01/04-ai-wizard.png)
...
![A x-ray side view of a person's head that shows their brain. The person is speaking, representing them sharing knowledge](/images/ground-zero/01/05-person-speaking.png)
...
![A student with thought bubbles that each have something different in them: a heart with a heartbeat line inside it, a book, and a smartphone](/images/ground-zero/01/06-thought-bubbles.png)
...
![A person playing a video game while thinking about how the gun firing mechanic works](/images/ground-zero/01/07-playing-game.png)
...
![A smartphone, a game controller, and a refrigerator](/images/ground-zero/01/08-phone-gamepad-fridge.png)
...
![A person driving a vehicle that is pushing two boulders up a hill while another person is riding on top of the vehicle](/images/ground-zero/01/09-climbing-hill.png)
...
![A person frustrated at the computer, getting programming help from another person](/images/ground-zero/01/10-getting-help.png)
